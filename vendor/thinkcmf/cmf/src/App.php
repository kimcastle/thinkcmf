            ...
            if (is_file($path . 'init.php')) {
                ...
                if ('' == $module) {
                    ...
                    if ($this->namespace == 'app' || $this->namespace == 'api') {
                        ...
                        //kimcastle-fixed
                        foreach ($mainConfigNames as $configName) {
                            $this->config->load(CMF_ROOT . "vendor/".GIT_PROJECT_NAME."/cmf-{$this->namespace}/src/" . $configName . $this->configExt, $configName);
                        }
                        ...
                        //kimcastle-fixed
                        $tagsFile = CMF_ROOT . "vendor/".GIT_PROJECT_NAME."/cmf-{$this->namespace}/src/" . 'tags.php';
                        if (is_file($tagsFile)) {
                            $tags = include $tagsFile;
                            if (is_array($tags)) {
                                $this->hook->import($tags);
