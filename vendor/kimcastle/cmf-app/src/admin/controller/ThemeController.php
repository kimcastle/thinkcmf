...
class ThemeController extends AdminBaseController
{
    ...
    public function uninstall()
    {
        ...
        if ($theme == "simpleboot3" || config('template.cmf_default_theme') == $theme) {
            $this->error("官方自帶模板或當前使用中的模板不可以卸載");
        }
        ...
        $this->success("卸載成功", url("theme/index"));
    ...
    public function installTheme()
    {
        ...
        $this->success("安裝成功", url("theme/index"));
    }
    ...
    public function active()
    {
        ...
        if ($theme == config('template.cmf_default_theme')) {
            $this->error('模板已啟用', url("theme/index"));
        }
        ...
        $this->success("模板啟用成功", url("theme/index"));
     ...
     * 模板文件數組數據添加編輯提交保存
     * @adminMenu(
     *     'name'   => '模板文件數組數據添加編輯提交保存',
     *     'parent' => 'index',
     *     'display'=> false,
     *     'hasView'=> false,
     *     'order'  => 10000,
     *     'icon'   => '',
     *     'remark' => '模板文件數組數據添加編輯提交保存',
     *     'param'  => ''
     * )
     */
    ...
    public function fileArrayDataDelete()
    {
        ...
        $this->success("刪除成功！", url('theme/fileArrayData', ['tab' => $tab, 'var' => $varName, 'file_id' => $fileId, 'widget' => $widgetName]));
    }
