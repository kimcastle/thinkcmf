...
/**
 * Class NavMenuController 前臺菜單管理控制器
...
class NavMenuController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        foreach ($arrResult as $r) {
            $r['str_manage'] = '<a class="btn btn-xs btn-primary" href="' . url("NavMenu/add", ["parent_id" => $r['id'], "nav_id" => $r['nav_id']]) . '">添加子菜單</a>
            <a class="btn btn-xs btn-primary" href="' . url("NavMenu/edit", ["id" => $r['id'], "parent_id" => $r['parent_id'], "nav_id" => $r['nav_id']]) . '">編輯</a> 
            <a class="btn btn-xs btn-danger js-ajax-delete" href="' . url("NavMenu/delete", ["id" => $r['id'], 'nav_id' => $r['nav_id']]) . '">刪除</a> ';
            $r['status']     = $r['status'] ? "顯示" : "隱藏";
            $array[]         = $r;
        }
    ...
    public function add()
    {
        ...
        foreach ($arrResult as $r) {
            $r['str_manage'] = '<a href="' . url("NavMenu/add", ["parent_id" => $r['id']]) . '">添加子菜單</a> | <a href="'
                . url("NavMenu/edit", ["id" => $r['id']]) . '">編輯</a> | <a class="J_ajax_del" href="'
                . url("NavMenu/delete", ["id" => $r['id']]) . '">刪除</a> ';
            $r['status']     = $r['status'] ? "顯示" : "隱藏";
    ...
    public function edit()
    {
        ...
        $array      = [];
        foreach ($arrResult as $r) {
            $r['str_manage'] = '<a href="' . url("NavMenu/add", ["parent_id" => $r['id'], "nav_id" => $intNavId]) . '">添加子菜單</a> | <a href="'
                . url("NavMenu/edit", ["id" => $r['id'], "nav_id" => $intNavId]) . '">編輯</a> | <a class="js-ajax-delete" href="'
                . url("NavMenu/delete", ["id" => $r['id'], "nav_id" => $intNavId]) . '">刪除</a> ';
            $r['status']     = $r['status'] ? "顯示" : "隱藏";
            $r['selected']   = $r['id'] == $intParentId ? "selected" : "";
            $array[]         = $r;
        }
