    ...
    public function run()
    {
        ...
        foreach ($coreApps as $app) {
            Lang::load([
                ...
                Env::get('root_path') . "vendor/".GIT_PROJECT_NAME."/cmf-app/src/{$app}/lang/{$langSet}/admin_menu.php",
                Env::get('root_path') . "vendor/".GIT_PROJECT_NAME."/cmf-app/src/{$app}/lang/{$langSet}/admin.php"
            ]);
        }
