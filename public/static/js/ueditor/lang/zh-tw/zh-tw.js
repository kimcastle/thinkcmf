...
UE.I18N['zh-tw'] = {
    ...
    'insertimage':{
        'static':{
            ...
            'searchBtn':{'value':"百度壹下"},
            'searchReset':{'value':"清空搜索"},
            'noneAlign':{'title':'無浮動'},
            'leftAlign':{'title':'左浮動'},
            'rightAlign':{'title':'右浮動'},
            'centerAlign':{'title':'居中獨占壹行'}
        },
        ...
        'errorNotSupport': 'WebUploader 不支持您的瀏覽器！如果妳使用的是IE瀏覽器，請嘗試升級 flash 播放器。',
        'errorLoadConfig': '後端配置項沒有正常加載，上傳插件不能正常使用！',
    ...
    'attachment':{
        'static':{
            ...
            'lang_start_upload':"開始上傳",
            'lang_drop_remind':"可以將文件拖到這裏，單次最多可選100個文件"
        },
    ...
    'scrawl':{
        'static':{
            'lang_input_previousStep':"上壹步",
            'lang_input_nextsStep':"下壹步",
            'lang_input_clear':'清空',
    ...
    'charts':{
        'static':{
            ...
            'lang_chart_align_same': '數據源與圖表X軸Y軸壹致',
    ...
    'help':{
        'static':{
            ...
            'lang_input_introduction':'UEditor是由百度web前端研發部開發的所見即所得富文本web編輯器，具有輕量，可定制，註重用戶體驗等特點。開源基於BSD協議，允許自由使用和修改代碼。',
    ...
    'searchreplace':{
        'static':{
            ...
            nextFindBtn:{value:"下壹個"},
            preFindBtn:{value:"上壹個"},
            nextReplaceBtn:{value:"下壹個"},
            preReplaceBtn:{value:"上壹個"},
            repalceBtn:{value:"替換"},
    ...
    'snapscreen':{
        'static':{
            ...
            lang_download:"點此下載",
            lang_step1:"第壹步，下載UEditor截圖插件並運行安裝。",
    ...
    'wordimage':{
        'static':{
            ...
            lang_step:"1、點擊頂部復制按鈕，將地址復制到剪貼板；2、點擊添加照片按鈕，在彈出的對話框中使用Ctrl+V粘貼地址；3、點擊打開後選擇圖片上傳流程。"
        },
        'fileType':"圖片",
